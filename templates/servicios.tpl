    ...
    <ul class="list-group list-group-flush">
        <li class="list-group-item">Noches de alojamiento (precio por hab. no por persona).</li>
        <li class="list-group-item">Uso del Spa (Ver horarios).</li>
        <li class="list-group-item">Desayuno  abundante y variado: Té, Agua Caliente, Café, Leche, Yoghurts, Jugo Exprimido, Agua Mineral, Jamón y Queso, Cereales, Mermeladas varias, Manteca, Queso untable, Medias Lunas, Pan Lactal - blanco y de salvado-, Tostadas, Frutas Varias.</li>
        <li class="list-group-item">Beneficios exclusivos para huéspedes en los menúes de la carta del restó ( no incluye bebida).</li>
        <li class="list-group-item">Sesión en camilla de jade de regalo para cada adulto.</li>
    </ul>
    <p></p>
    <div class="alert alert-dismissible alert-warning">
        <h4 class="alert-heading">Importante!</h4>
